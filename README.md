...
During my academic journey, i've implemented a data persistence system in C and worked a little with embedded systems as a group, building a battle robot using Arduino. As a fullstack developer, i've worked with technologies such as Java Spring Boot and Angular. More recently, been focusing on TypeScript and Next.js, enhancing my expertise in scalable and modern web development. 🚀
</p>
...
:outbox_tray: 2025 Goals: colaborate on new projects and make some good networks.
...
- Data: 
    ...
    [![My Skills](https://skillicons.dev/icons?i=mysql,mongo,postgres,postman)](https://skillicons.dev)
- Tools and Technologies: 

    [![My Skills](https://skillicons.dev/icons?i=git,github,vscode,wordpress,figma)](https://skillicons.dev)
